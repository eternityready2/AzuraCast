...
final class StationPlaylistGroup implements JsonSerializable, IdentifiableEntityInterface
{
    ...
    /** Compatibility alias for older fork code while the upstream model is adopted. */
    public StationPlaylist $group {
        get => $this->playlist_group;
    }
    ...
    /** Compatibility alias for the former flat member position. */
    public int $position {
        get => $this->weight;
