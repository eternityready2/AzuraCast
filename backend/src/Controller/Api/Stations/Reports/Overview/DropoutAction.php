...
#[OA\Get(
    path: '/station/{station_id}/reports/overview/dropout',
    operationId: 'getStationReportDropout',
    summary: 'Get songs with listener dropouts within 30 seconds of track start.',
...
final class DropoutAction extends AbstractReportAction
{
    ...
    public function __invoke(
        ...
        return $response->withJson(
            $this->analyticsService->getSongDropouts($station, $dateRange),
        );
    }
}
