    ...
    () => {
        const form = ref<StationRecord>({
            ...
            backend_config: {
                ...
                autodj_queue_lookahead_minutes: 0,
                ...
                ai_news_last_generation_status: null,
                ai_news_last_generation_time: null,
                ai_news_last_error: null,
                dmca_compliance_enabled: false,
                dmca_window_minutes: 180,
                dmca_max_song_plays: 3,
                dmca_max_consecutive_song: 2,
            ...
            },
            {
                validationGroups: (fields) => ({
                    ...
                    frontendTab: [
                        ...
                        fields.frontend_config.trusted_proxy_address,
                    ...
                    backendTab: [
                        ...
                        fields.backend_config.autodj_queue_lookahead_minutes,
